...
public class LimelightHelpers {
    ...
    public static class RawFiducial {
        ...
        @Override
        public int hashCode() {
            return Arrays.hashCode(new Object[] { id, txnc, tync, ta, distToCamera, distToRobot, ambiguity });
        }
    ...
    public static class RawTarget {
        ...
        @Override
        public int hashCode() {
            return Arrays.hashCode(new Object[] { txnc, tync, ta });
        }
    }
    ...
    public static class PoseEstimate {
        ...
        public int hashCode() {
            ...
            result = 31 * result + Double.hashCode(tagSpan);
