...
public class IntakeREVIO implements IntakeIO {
    ...
    private final SparkFlexConfig sparkMotorConfig = new IntakeConfiguration().getSparkMotorConfig();
    ...
    public IntakeREVIO() {
        /*
         * sparkMotorConfig.closedLoop.feedbackSensor(FeedbackSensor.
         * kDetachedAbsoluteEncoder, 43)
